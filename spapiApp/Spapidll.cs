...
namespace spapiApp
{
    ...
    public class Spapidll
    {
        ...
        {
            string prc_info;
            prc_info = "API PriceUpdate: ProdCode=" + prc.ProdCode + ", Bid=" + prc.Bid[0] + ", BQty=" + prc.BidQty[0] + ", Ask=" + prc.Ask[0] + ", AQty=" + prc.AskQty[0] + " LastTime:" + prc.LastTime[0].ToString() + " DecInPrice:" + prc.DecInPrice.ToString();
            if (DllShowTextData != null) DllShowTextData(prc_info);
        }
        ...
        ///<summary>rob专用输出方法</summary>
        public void output(String data) {

            DllShowTextData(data);
